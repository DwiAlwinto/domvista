...
<div class="page">
				...
				<div class="container-xl">
					...
					<div class="navbar-nav flex-row order-md-last">
						<div class="nav-item d-none d-md-flex me-3">
							<div class="btn-list">
								<a href="https://www.instagram.com/alwiin_" class="btn btn-6" target="_blank" rel="noreferrer">
					...
					<div class="nav-item dropdown">
							<a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
								<span class="avatar avatar-sm" style="background-image: url(vendor/admin/static/avatars/000m.jpg)"></span>
							...
							<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
								<a href="vendor/admin/profile.html" class="dropdown-item">Profile</a>
								<div class="dropdown-divider"></div>
									<a href="vendor/admin/settings.html" class="dropdown-item">Settings</a>
										<a href="vendor/admin/sign-in.html" class="dropdown-item">Logout</a>
								</div>
						</div>
					</div>
		 	</header>
			...
			<header class="navbar-expand-md">
				<div class="collapse navbar-collapse" id="navbar-menu">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="vendor/admin/" >
						...
						<div class="dropdown-menu">
							<div class="dropdown-menu-columns">
								<div class="dropdown-menu-column">
									<a class="dropdown-item" href="vendor/admin/accordion.html">
										Accordion
									</a>
									<a class="dropdown-item" href="vendor/admin/alerts.html">
										Alerts
									</a>
							<div class="dropend">
							...
							<div class="dropdown-menu">
								<a href="vendor/admin/sign-in.html" class="dropdown-item">
									Sign in
								</a>
								<a href="vendor/admin/sign-in-link.html" class="dropdown-item">
									Sign in link
								</a>
							</div>
						</div>
				...
				<div class="row text-center align-items-center flex-row-reverse">
					<div class="col-lg-auto ms-lg-auto">
						<ul class="list-inline list-inline-dots mb-0">
							...
							<li class="list-inline-item"><a href="vendor/admin/license.html" class="link-secondary">License</a></li>
					...
					<div class="col-12 col-lg-auto mt-3 mt-lg-0">
						<ul class="list-inline list-inline-dots mb-0">
							...
							<li class="list-inline-item">
								<a href="vendor/admin/changelog.html" class="link-secondary" rel="noopener">
									v1.0.0
								</a>
							</li>
						</ul>
	...
	<!-- Libs JS -->
<script src="vendor/admin/dist/libs/apexcharts/dist/apexcharts.min.js?1738096685" defer></script>
			<script src="vendor/admin/dist/libs/jsvectormap/dist/jsvectormap.min.js?1738096685" defer></script>
			<script src="vendor/admin/dist/libs/jsvectormap/dist/maps/world.js?1738096685" defer></script>
			<script src="vendor/admin/dist/libs/jsvectormap/dist/maps/world-merc.js?1738096685" defer></script>
			<!-- Tabler Core -->
<script src="vendor/admin/dist/js/tabler.min.js?1738096685" defer></script>
<script src="vendor/admin/dist/js/demo.min.js?1738096685" defer></script>
</body>
</html>
